...
def getXY(data, indices, xKeywords, yKeyword, distRange=[0.,10000.],withSquares=True):
    x = []
    y = []
...
def run():
    ...
    xKeyWords = [['B','V','R'],['u','g','r'],['r','i','z'],['R','I']]
    ...
    #            print('indices = ',indices)
                x,y = getXY(dat, indices, xKeys, yKey, distRange, withSquares)
                ...
                if True:
                    ...
                    xTest, yTest = getXY(datTest, indicesTest, xKeys, yKey, distRange, withSquares)
                    #print 'yTest = ',yTest

...
fNameGaiaXSimbadRoot = '/Volumes/obiwan/azuri/data/gaia/x-match/GaiaDR2xSimbad/xy/GaiaXSimbad_%.6f-%.6f_%.6f-%.6f_%s.csv'
fNameGaiaXSDSSRoot = '/Volumes/obiwan/azuri/data/gaia/x-match/GaiaDR2distXSDSS12/xy/Gaia+SDSS_%.6f-%.6f_%.6f-%.6f.csv'
